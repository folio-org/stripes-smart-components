    ...
    this.getUpdatedLoans()
      ...
      .reduce(
        (previous, current) => previous
          .then(prevResult => current
            .then(currentResult => (prevResult ? [...prevResult, currentResult] : [currentResult]))),
        Promise.resolve()
      )
      .then(finalResults => { this.props.onDueDateChanged(finalResults); });
  }
