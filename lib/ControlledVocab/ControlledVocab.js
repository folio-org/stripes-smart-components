...
class ControlledVocab extends React.Component {
  ...
  static propTypes = {
    ...
    /*
      ...
      {
        cannotDeleteTermHeader: "Cannot delete {type}",
        cannotDeleteTermMessage: "This {type} cannot be deleted, as it is in use by one or more records.",
        deleteEntry: "Delete {entry}",
        termDeleted: "The {type} <b>{term}</b> was successfully <b>deleted</b>",
        termWillBeDeleted: "The {type} <b>{term}</b> will be <b>deleted.</b>"
      }
    */
