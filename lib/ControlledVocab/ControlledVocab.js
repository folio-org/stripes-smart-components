...
class ControlledVocab extends React.Component {
  static manifest = Object.freeze({
    values: {
      ...
      GET: {
        path: `!{baseUrl}?query=cql.allRecords=1 sortby !{sortby:-name}&!{limitParam:-limit}=${RECORDS_LIMIT}`
      }
    },
    ...
    return (
      <Paneset id={this.id} {...dataProps}>
        <Pane
          ...
          dismissible={!!this.props.dismissPane}
          onClose={this.props.dismissPane}
        >
