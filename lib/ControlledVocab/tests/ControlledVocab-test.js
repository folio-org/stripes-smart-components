...
describe('ControlledVocab', () => {
  ...
  describe('render CV when personal object of user details does not exist ', () => {
    ...
    beforeEach(async () => {
      const userWithoutPersonalObj = {
        'username': 'jharvard',
        'id': 'user-1',
        metadata: {
          createdByUserId: 'c0938a9c-66fc-5397-835c-edf8b5bb6d23',
          createdDate: '2023-08-22T06:31:15.993+00:00',
          updatedByUserId: 'c0938a9c-66fc-5397-835c-edf8b5bb6d23',
          updatedDate: '2023-08-22T06:47:37.604+00:00',
        }
      };
      this.server.put('/users', userWithoutPersonalObj);
      // eslint-disable-next-line no-undef
      await mountComponent(false, server, { labelSingular });

      it('should have row count 5', () => cv.has({ rowCount: 5 }));
      it('should render empty string for updated by name ', () => EditableListRow().find(TextField('lastUpdated'))).fillIn('8/22/2023  by');
    });
  });
});
