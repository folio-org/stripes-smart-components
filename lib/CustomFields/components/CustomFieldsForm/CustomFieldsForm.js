...
const CustomFieldsForm = ({
  ...
  const insertDeletedOptions = () => {
    ...
    Object.keys(optionsToDelete).forEach(fieldId => {
      ...
      mergedOptions.sort((opt1, opt2) => opt1.value.localeCompare(opt2.value));
      form.change(optionsStatePath, mergedOptions);
    });
  };
                ...
                <>
                  ...
                  <AddButton
                    ...
                    handleAdd={(type) => {
                      ...
                      fields.push({
                        values: {
                          ...getDefaultFieldConfigs({ hasDisplayInAccordionField })[type],
                          entityType,
                        },
                        id,
                      });
