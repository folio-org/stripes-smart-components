...
const CustomFieldsForm = ({
  ...
  const initialFormState = {
    ...
    pristine: true,
    fieldsToDelete: [],
    title: intl.formatMessage({ id: 'stripes-smart-components.customFields.recordAccordion.defaultName' }),
  };
    ...
    switch (type) {
      ...
      case UPDATE_TITLE: {
        return {
          ...state,
          title: payload,
          pristine: isEqual(payload, sectionTitle),
        };
      }
      default: {
        return state;
  ...
  const accordionNameInput = (
    <TextField
      autoFocus
      value={sectionTitle.value || title}
