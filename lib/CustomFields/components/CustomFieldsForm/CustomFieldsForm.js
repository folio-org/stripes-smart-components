...
const CustomFieldsForm = ({
  ...
  const onDeleteOption = (fields, index) => values => {
    fields.update(index, {
      ...fields.value[index],
      values: {
        ...fields.value[index].values,
        selectField: {
          ...fields.value[index].values.selectField,
          options: {
            ...fields.value[index].values.selectField.options,
            values,
          }
        }
      }
      ...
      >
        {fields.map((name, index) => (
          <FieldAccordion
            ...
            onDeleteOption={onDeleteOption(fields, index)}
            isEditMode
