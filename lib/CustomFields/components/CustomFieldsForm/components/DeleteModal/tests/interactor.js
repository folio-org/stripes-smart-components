...
export default interactor(class DeleteModalInteractor {
  ...
  modalIsPresent = isPresent('[data-test-delete-custom-fields-modal]');
  loadingIconIsPresent = isPresent('#custom-fields-statistics-loading-icon');

  customFieldsWarningMessages = collection('[data-test-custom-field-delete-warning]');
  optionWarningMessages = collection('[data-test-custom-field-option-delete-warning]');
