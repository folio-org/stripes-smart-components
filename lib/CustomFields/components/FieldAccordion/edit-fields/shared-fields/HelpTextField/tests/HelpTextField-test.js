  ...
  describe('when editing field', () => {
    describe('and filling in invalid data', () => {
      ...
      it('should show error message', () => {
        expect(helpTextField.errorMessage).to.equal('100 character limit has been exceeded. Please revise.');
      });
    });
    ...
    describe('and filling in valid data', () => {
      ...
      it('should not show error message', () => {
        expect(helpTextField.errorMessagePresent).to.be.false;
      });
    });
  });
});
