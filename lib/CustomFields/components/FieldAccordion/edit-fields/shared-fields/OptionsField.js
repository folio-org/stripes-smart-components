            ...
            <>
              ...
              <div className={css.listWrapper}>
                <MultiColumnList
                  ...
                  isEmptyMessage={null}
                  formatter={{
                    label: rowData => !!rowData.rowIndex && (
                      <Field
                        className={css.optionInput}
                        name={`${fieldNamePrefix}.selectField.options.values[${rowData.rowIndex - 1}]`}
                  ...
                  columnMapping={{
                    ...
                    defaults: <FormattedMessage id="stripes-smart-components.customFields.options.default" />,
                  }}
                  columnWidths={{
                    label: '90%',
                    defaults: '10%',
