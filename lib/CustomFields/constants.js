...
export const fieldTypesLabels = {
  ...
  [fieldTypes.SINGLE_CHECKBOX]: (
    <FormattedMessage id="stripes-smart-components.customFields.fieldTypes.SINGLE_CHECKBOX" />
  ),
  [fieldTypes.SINGLE_SELECT_DROPDOWN]: (
    <FormattedMessage id="stripes-smart-components.customFields.fieldTypes.SINGLE_SELECT_DROPDOWN" />
  ),
};
...
export const defaultFieldConfigs = {
  ...
  [fieldTypes.SINGLE_SELECT_DROPDOWN]: {
    ...
    required: false,
    helpText: '',
    type: fieldTypes.SINGLE_SELECT_DROPDOWN,
    selectField: {
      multiSelect: false,
    }
  }
