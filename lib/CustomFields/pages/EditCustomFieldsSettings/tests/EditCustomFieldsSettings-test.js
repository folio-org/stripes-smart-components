    ...
    describe('when updating a field and saving', () => {
      ...
      it('should send correct `displayInAccordion` field value', () => {
        return converge(() => {
          ...
          if (secondField.displayInAccordion !== 'customFields') {
            throw new Error(`expected secondField displayInAccordion to be 'customFields', got ${secondField.displayInAccordion}`);
          }
    ...
    describe('when adding a new field and saving', () => {
      ...
      it('should send `displayInAccordion` field', () => {
        return converge(() => {
          ...
          if (body.customFields[7].displayInAccordion !== 'customFields') {
            throw new Error('expected displayInAccordion to have "customFields" as its default value');
          }
        });
      });
    });
