...
class EntryForm extends React.Component {
    ...
    return (
      <PaneMenu>
        <Button
          ...
          type="submit"
          title={this.props.stripes.intl.formatMessage({id: "stripes-core.button.save"})}
          disabled={(pristine || submitting)}
          marginBottom0
        >{this.props.stripes.intl.formatMessage({id: "stripes-core.button.save"})}
        </Button>
      </PaneMenu>
    );
  }
  ...
  render() {
    ...
    const paneTitle = selectedEntry && selectedEntry.id ? this.props.stripes.intl.formatMessage({id: "stripes-core.label.editEntry"}, {entry: this.props.entryLabel}) : 
          ...
          <Pane defaultWidth="100%" firstMenu={this.addFirstMenu()} lastMenu={this.saveLastMenu()} paneTitle={paneTitle}>
            ...
            {selectedEntry &&
              <ConfirmationModal
                ...
                message={(<span>{this.props.stripes.intl.formatMessage({id: "stripes-core.label.confirmDeleteEntry"}, {entry: selectedEntry[this.props.nameKey] || "Untitled" + this.props.entryLabel})}</span>)}                
