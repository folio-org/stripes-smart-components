  ...
  render() {
    ...
    return (
      <form id="location-form" onSubmit={handleSubmit(this.onSave)}>
        <Row>
          ...
          <Col xs={6}>
            <Field
              ...
              name="locationId"
              onChange={e => this.onLocationSelected(e.target.value)}
        ...
        <Row>
          <Col xs={2}>
            <Button onClick={onCancel} fullWidth>Cancel</Button>
          </Col>
          <Col xs={2}>
            <Button disabled={!locId} type="submit" buttonStyle="primary" fullWidth>Save</Button>
          </Col>
        </Row>
      </form>
    );
