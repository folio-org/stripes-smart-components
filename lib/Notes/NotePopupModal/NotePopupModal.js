...
const propTypes = {
  ...
  popUpFooterPrimaryAction: PropTypes.oneOf(['close', 'delete']),
...
const defaultProps = {
  ...
  popUpFooterPrimaryAction: 'delete',
...
const NotePopupModal = ({
  ...
  const footer = (
    <ModalFooter buttonsAlignReverse={popUpFooterPrimaryAction !== 'delete'}>
      {
        !hideDelete && (
          <Button
            data-test-note-popup-modal-delete-button
            buttonStyle={popUpFooterPrimaryAction === 'delete' ? 'primary' : 'default'}
            onClick={onDelete}
          >
            {deleteLabel}
          </Button>
      ...
      <Button
        ...
        buttonStyle={popUpFooterPrimaryAction === 'close' ? 'primary' : 'default'}
        onClick={onClose}
      >
        {closeLabel}
      </Button>
