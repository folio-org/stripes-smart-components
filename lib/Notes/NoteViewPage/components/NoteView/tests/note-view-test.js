...
describe('NoteView', () => {
  ...
  describe('rendering NoteView component with inserted Referred Record element', () => {
    ...
    it('should display inserted Reffered Record element', () => insertedReferredRecord().exists());
  });
  ...
  describe('rendering NoteView component with suspicious content', () => {
    ...
    it('should screen suspicious content for display', () => NoteContent('Details').has({ markup: cleanContent }));
  });
});
