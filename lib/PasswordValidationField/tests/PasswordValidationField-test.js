...
describe('PasswordValidationField', () => {
  ...
  describe('with an invalid password', () => {
    ...
    it('shows a validation error for invalid length', () => passwordField.has({ error: 'The password length must be minimum 8 symbols.' }));
  });
  ...
  describe('with valid password and final form', () => {
    ...
    it('doesnt show a validation error', () => passwordField.has({ valid: true }));
  });
  ...
  describe('with invalid password and final form', () => {
    ...
    it('shows a validation error', () => passwordField.has({ error: 'The password length must be minimum 8 symbols.' }));
  });
});
