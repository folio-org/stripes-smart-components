...
import { usePasswordValdiationRules } from './usePasswordValidationRules';
...
describe('usePasswordValdiationRules', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  ...
  it('fetches enabled password validation rules for the current tenant', async () => {
    ...
    const { result } = renderHook(() => usePasswordValdiationRules(), {
