...
class SearchAndSort extends React.Component {
  ...
  render() {
    ...
    const paneSub = (_.isEmpty(filters) && (displayedRecords !== null && _.isEmpty(displayedRecords.records)) && searchTerm === '') ? formatMsg({ id: 'stripes-smart-components.searchCriteria' }) : formatMsg({ id: `ui-${moduleName}.resultCount` }, { count });
    return (
      <Paneset>
