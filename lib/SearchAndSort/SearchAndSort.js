...
class SearchAndSort extends React.Component {
  ...
  onSort = (e, meta) => {
    ...
    const oldOrder = _.get(this.props.parentResources.query, 'sort');
  ...
  render() {
    ...
    const searchTerm = _.get(this.props.parentResources.query, 'searchTerm');
    ...
    const sortOrder = _.get(this.props.parentResources.query, 'sort') || '';
    const filters = initialFilterState(this.props.filterConfig, _.get(this.props.parentResources.query, 'filters'));
