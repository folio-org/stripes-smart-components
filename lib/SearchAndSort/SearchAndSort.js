...
class SearchAndSort extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {  // eslint-disable-line react/no-deprecated
    ...
    const oldState = makeConnectedSource(this.props, logger, this.props.resourceName);
    const newState = makeConnectedSource(nextProps, logger, nextProps.resourceName);
  ...
  onNeedMore = () => {
    const source = makeConnectedSource(this.props, this.props.stripes.logger, this.props.resourceName);
  ...
  render() {
    ...
    const source = makeConnectedSource(this.props, stripes.logger, this.props.resourceName);
