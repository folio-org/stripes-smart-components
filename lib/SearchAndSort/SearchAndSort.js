...
class SearchAndSort extends React.Component {
  ...
  onSelectRow = (e, meta) => {
    ...
    if (this.state.selectedItem === meta) {
      this.detailTitleRef.focus();
    } else {
      this.transitionToParams({ _path: `${this.props.packageInfo.stripes.route}/view/${meta.id}` });
      this.setState({ selectedItem: meta });
      this.SRStatus.sendMessage('Item selected, press enter to skip to details');
    }
  }
        ...
        (
          <Route
            ...
            render={props => <this.connectedViewRecord
              ...
              paneTitleRef={(r) => { this.detailTitleRef = r; }}
              {...props}
              {...detailProps}
            />}
          />
    ...
    return (
      <Paneset>
        ...
        <Pane
          ...
          paneTitleRef={(r) => { this.resultsPaneTitle = r; }}
