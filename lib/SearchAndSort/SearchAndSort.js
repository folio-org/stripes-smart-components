...
class SearchAndSort extends React.Component {
  ...
  constructor(props) {
    ...
    this.filterPaneVisibilityKey = '@folio/inventory/inventoryFilterPaneVisibility';
    ...
    this.state = {
      ...
      filterPaneIsVisible: storedFilterPaneState !== null ? storedFilterPaneState : true,
  ...
  render() {
    ...
    return (
      <PersistedPaneset data-test-search-and-sort>
