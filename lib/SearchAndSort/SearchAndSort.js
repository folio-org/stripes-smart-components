...
class SearchAndSort extends React.Component {
  ...
  render() {
    ...
    const paneSub = (_.isEmpty(filters) && _.isEmpty(parentResources.records.records) && searchTerm === '') ? formatMsg({ id: 'stripes-smart-components.searchCriteria' }) : formatMsg({ id: `ui-${moduleName}.resultCount` }, { count });
