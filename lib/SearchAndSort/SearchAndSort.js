...
import makeConnectedSource from './ConnectedSource/ConnectedSource';
...
class SearchAndSort extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    const oldAnalyzer = makeConnectedSource(this.props, logger);
    const newAnalyzer = makeConnectedSource(nextProps, logger);

    {
      // If the nominated mutation has finished, select the newly created record
      const finishedOldAnalyzer = makeConnectedSource(this.props, logger, this.props.finishedResourceName);
      const finishedNewAnalyzer = makeConnectedSource(nextProps, logger, this.props.finishedResourceName);
  ...
  onNeedMore = () => {
    const analyzer = makeConnectedSource(this.props, this.context.stripes.logger);
