...
class SearchAndSort extends React.Component {
  static propTypes = {
    ...
    resultIsSelected: PropTypes.func,
    resultRowClickHandlers: PropTypes.bool,
    ...
    resultsSelectedItem: PropTypes.object,
    ...
    viewRecordOnCollapse: PropTypes.func,
  ...
  static defaultProps = {
    ...
    resultRowClickHandlers: true,
    selectedIndex: '',
    hasNewButton: true,
    resultIsSelected: ({ item, criteria }) => {
      if (criteria) {
  ...
  constructor(props) {
    ...
    this.state = {
      selectedItem: resultsSelectedItem || this.initiallySelectedRecord,
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    if (!isMatch(nextProps.resultsSelectedItem, this.state.selectedItem)) {
      this.setState({ selectedItem: nextProps.resultsSelectedItem });
    }
  }
      ...
      >
        {([ariaLabel]) => (
          <MultiColumnList
            ...
            onRowClick={viewRecordPathById || !resultRowClickHandlers ? undefined : this.onSelectRow}
