...
class SearchAndSort extends React.Component {
  ...
  render() {
    ...
    const message = (<NoResultsMessage analyzer={source} searchTerm={searchTerm} filterPaneIsVisible={filterPaneIsVisible} toggleFilterPane={this.toggleFilterPane} />);
