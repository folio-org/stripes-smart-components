...
class SearchAndSort extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    const oldAnalyzer = new ResourcesAnalyzer(this.props.parentResources, this.context.stripes.logger);
    const newAnalyzer = new ResourcesAnalyzer(nextProps.parentResources, this.context.stripes.logger);
