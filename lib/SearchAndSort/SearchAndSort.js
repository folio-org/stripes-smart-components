...
class SearchAndSort extends React.Component {
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    // If the result is a single hit, automatically open the detail view
    if (newState.totalCount() === 1 &&
      nextProps.showSingleResult &&
      ((oldState.records()[0] !== newState.records()[0]) || (oldState.records()[0] === undefined))) {
