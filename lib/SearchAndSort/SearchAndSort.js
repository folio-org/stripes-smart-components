...
function noRecordsMessage(analyzer, searchTerm, filterPaneIsVisible, toggleFilterPane) {
  ...
  // Filters selected but no results
  ...
  return (
    <div className={css.emptyMessage}>
      ...
      { !filterPaneIsVisible && <Button marginBottom0 buttonClass={css.emptyMessageButton} onClick={toggleFilterPane}>Show filters</Button>}
    </div>
  );
}
...
class SearchAndSort extends React.Component {
  ...
  render() {
    ...
    const message = noRecordsMessage(analyzer, searchTerm, filterPaneIsVisible, this.toggleFilterPane);
