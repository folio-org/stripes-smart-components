...
class SearchAndSortQuery extends React.Component {
  ...
  constructor(props) {
    ...
    this.initialSearch = this.initialQuery.query || '';
    ...
    */
    this.state = {
      searchFields: props.initialSearchState ||
      {
        query: this.initialSearch,
      },
      filterFields: props.initialFilterState || {
        filters: this.initialFilters,
      },
      sortFields: props.initialSortState || {
  ...
  onChangeSearchValue = (value, name) => {
    ...
    this.internalSetState({ searchFields: { [name]: value } }, 'search');
  };
  ...
  onChangeSearchEvent = (e) => {
    ...
    // this.setState({ [fieldName]: query }, () => this.props.searchChangeCallback(query));
    this.internalSetState({ searchFields: { [fieldName]: query } }, 'search');
  };
  ...
  internalSetState = (stateToSet, changeType, callbacks) => {
    ...
    this.setState(curState => {
      ...
      nextState.searchChanged = !isEqual(
        ...
        initialSearchState || { query: this.initialSearch }
      );
      nextState.filterChanged = !isEqual(
        nextState.filterFields,
        initialFilterState || { filters: this.initialFilters }
      );
      nextState.sortChanged = !isEqual(nextState.sortFields, initialSortState || { sort: this.initialSort });
  ...
  onResetSearch = () => {
    ...
    this.internalSetState(
      {
        searchFields: initialSearchState || { query: this.initialSearch }
      },
      'search',
      [
        searchChangeCallback
  ...
  onResetFilter = () => {
    ...
    this.internalSetState(
      {
        filterFields: initialFilterState || { filters: this.initialFilters }
      },
      'filter',
      [
        filterChangeCallback,
  ...
  render() {
    ...
    return children({
      ...
      onClearSearch: this.onClearSearchFields,
