...
import { useSetRefOnFocus } from '../../../utils';
import {
  isDateValid,
  validateDateRange,
...
const MemoizedComponent = memo(DateRangeFilter, areSelectedValuesEqual);
MemoizedComponent.propTypes = DateRangeFilter.propTypes;
