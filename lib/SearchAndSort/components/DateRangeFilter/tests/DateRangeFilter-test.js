...
describe.only('DateRangeFilter', () => {
  ...
  describe('when manually entering the dates', () => {
    ...
    describe('when entering invalid start date', () => {
      ...
      it('should display corresponding error', () => {
        expect(dateRangeFilter.startDateInvalidErrorIsShown).to.be.true;
      });
    ...
    describe('when invalid end date is entered', () => {
      ...
      it('should display corresponding error', () => {
        expect(dateRangeFilter.endDateInvalidErrorIsShown).to.be.true;
      });
    ...
    describe('when trying to apply the filter with missing start date', () => {
      ...
      it('should show corresponding error', () => {
        expect(dateRangeFilter.startDateMissingErrorDisplayed).to.be.true;
      });
    ...
    describe('when trying to apply the filter with missing end date', () => {
      ...
      it('should show corresponding error', () => {
        expect(dateRangeFilter.endDateMissingErrorDisplayed).to.be.true;
      });
    ...
    describe('when trying to apply the filter with wrong dates order', () => {
      beforeEach(async () => {
        await dateRangeFilter.startDateInput.enterDate('2005-01-03');
      ...
      it('should show corresponding error', () => {
        expect(dateRangeFilter.wrongOrderDatesErrorIsShown).to.be.true;
      });
