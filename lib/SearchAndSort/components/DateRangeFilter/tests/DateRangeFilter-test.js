...
import { TextInput, Datepicker, HTML } from '@folio/stripes-testing';
...
describe('DateRangeFilter', () => {
  ...
  describe('and start date is greater than end date', () => {
    ...
    it.only('should render aria-labels appropriately', () => TextInput({ ariaLabel: 'test start label' }).exists());
