...
describe('SearchAndSortQuery Navigation', () => {
  ...
  describe('when using addIsInitialParameterToQuery with initial query state', () => {
    const querySetter = sinon.spy();
    ...
    it('should call querySetter with _isInitial parameter', () => {
      expect(querySetter.calledWithMatch({
        values: {
          qindex: 'title',
          query: 'testSearch',
          filters: {
