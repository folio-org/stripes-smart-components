  ...
  render() {
    ...
    return (
      <Badge className={css.tag} color="primary">
        <span>{tag}</span>
        <Button onClick={(e) => onRemove(tag)} size="small" paddingSide0={true} marginBottom0={true} buttonStyle="primary" aria-label={formatMsg({ id: 'stripes-smart-components.deleteTag' })}>
