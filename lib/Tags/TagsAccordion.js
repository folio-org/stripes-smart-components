...
import { Accordion, Headline, Badge } from '@folio/stripes-components';

import Tags from './Tags';

const TagsAccordion = React.memo(
  ({
    link,
    getEntity,
    getEntityTags,
    ...
    <Tags
      ...
      entityTagsPath={entityTagsPath}
      hasOptimisticLocking={hasOptimisticLocking}
